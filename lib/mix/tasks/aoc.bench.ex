defmodule Mix.Tasks.Aoc.Bench do
  ...
  Bench all solutions and save `missing` benchmarks.
      ...
      Saved benchmarks to README.md

  Bench all solutions in `2025` and save `all` benchmarks.

  	  $ mix aoc.bench 2025 all
      Benching lib/bin/Y2025/D01.ex
      -----------------------------
      part_one: 1.2µs (5)
      part_two: 0.6µs (5)
  ...
  @impl Mix.Task
  def run(args) do
    {%{"save" => save, "year" => year, "day" => day, "times" => times}, _} =
      AOC.Args.parse(args)
